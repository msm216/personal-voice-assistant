...
## provide the output according to the processed data, arg*: string
...
## get the audio from user using microphone
def get_audio():
...
## provide the reaction of "Person"
...
## web crawler which uses selenium package to process
